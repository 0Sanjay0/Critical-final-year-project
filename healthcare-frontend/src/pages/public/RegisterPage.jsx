...
const ROLES = [
  {
    value: 'patient',
    label: 'Patient',
    desc: 'Manage health records & QR code',
    color: 'border-blue-400 bg-blue-50',
  },
  {
    value: 'doctor',
    label: 'Doctor',
    desc: 'Treat patients & send prescriptions',
    color: 'border-emerald-400 bg-emerald-50',
  },
  {
    value: 'hospital',
    label: 'Hospital',
    desc: 'Emergency access & coordination',
    color: 'border-violet-400 bg-violet-50',
  },
  {
    value: 'lab',
    label: 'Lab',
    desc: 'Upload diagnostic reports',
      ...
      <div className="w-full max-w-lg animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">
            Join Critical — free for all roles
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {['doctor', 'hospital', 'lab'].includes(form.role) && (
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 text-xs text-amber-700">
                <strong>Note:</strong> {form.role} accounts require document
                verification by admin before you can access patient data. You'll
                be able to submit your documents after registration.
              </div>
            )}
